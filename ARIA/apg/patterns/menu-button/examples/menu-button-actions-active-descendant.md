...
ref: /ARIA/apg/patterns/menu-button/examples/menu-button-actions-active-descendant/

github:
  repository: w3c/aria-practices
  branch: main
  path: content/patterns/menu-button/examples/menu-button-actions-active-descendant.html
feedbackmail: public-aria-practices@w3.org
permalink: /ARIA/apg/patterns/menu-button/examples/menu-button-actions-active-descendant/

sidebar: true

footer: "      <div class='example-page-footer'>        <p><a href='https://github.com/w3c/aria-practices/projects/5'>View issues related to this example</a></p>        <p>Page last updated: 8 December 2022</p>      </div>    "
...
<title>Actions Menu Button Example Using aria-activedescendant</title>
...
<link
  ...
  rel="stylesheet"
/>
<script src="../../../../../../content-assets/wai-aria-practices/patterns/menu-button/examples/js/menu-button-actions-active-descendant.js"></script>
...
<div>
  ...
  >
        ...
        <p>
          This implementation manages focus in the menu as described in the section on
            ...
            <tr data-test-id="menu-tabindex">
              ...
              <td>
                <ul>
                  ...
                  <li>
                    Note that users never perceive the menu container as focused.
                    When the menu is open, only menu items are perceived as focused.
                  </li>
                </ul>
              </td>
            </tr>
